    ...
    try {
        ...
        fetch(`/api/config`)
            ...
            .then(data => {
                ...
                // non-restricted instance" default - used by the Fleet Overview prototype's
                // card-click navigation (fleet-overview-test-blue.html opens index.html?db_id=<id>).
...
// Fills the SQL 정합성/튜닝 메뉴 with the popup's session data and switches to it, exactly like the
// button used to do in-page before session detail moved to its own window.
