...
- ②③ 차트 행은 **창 높이에 맞춰 300~400px**(처음 320px 고정 → 400px 고정 → 2026-09-26 창 높이 연동: 대시보드 영역 − 나머지 블록 높이, 부하·데이터와 무관) (2026-09-26 결정 — 처음엔 남는 세로 공간을 모두 가져가게 했으나 부하·배율에 따라 차트 크기가 들쭉날쭉해 고정). 남는 공간은 아래 여백.
...
| 항목 | 기준 |
|---|---|
| TX 대기 세션 | 0~4 정상 / 5~9 주의 / **10 이상 위험** (2026-09-26 변경, 예전 1~4 주의·5 위험) |
| TM 대기 세션 | 0~2 정상 / 3~5 주의 / **6 이상 위험** (2026-09-26 변경, 예전 1~2 주의·3 위험) |
...
- 차트: 계단형 선(step) 2개 (TX, TM), TX는 옅은 면 채움. TX 주의 기준 5건 점선. 오른쪽 끝에 현재값 직접 라벨 (`TX 14`, `TM 12`).
